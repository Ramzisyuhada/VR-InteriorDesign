...
namespace YVR.Core
{
    ...
    public class YVRCameraRig : YVRBaseRig
    {
        ...
        {
            InputDevice deviceCenterEye = yvrXRDevices.Count > 0 ? yvrXRDevices[(int)YVRXRDeviceNode.Headset] : default;
        ...
        /// <summary>
        /// Whether recenter occurred this frame
        /// </summary>
        /// <returns> true if recenter occurred in this frame </returns>
        public static bool IsRecenterOccurred()
        {
            return YVRPlugin.Instance.IsRecenterOccurred();
        }
        ...
        {
            return YVRPlugin.Instance.GetHeadsetPositionTracked();
        }
        ...
        {
            return YVRPlugin.Instance.GetHeadsetOrientationTracked();
        }
        ...
        {
            return yvrXRDevices[(int)YVRXRDeviceNode.Headset].isValid;
        }
        ...
        {
            bool succeed = yvrXRDevices[(int)YVRXRDeviceNode.Headset].TryGetFeatureValue(CommonUsages.centerEyePosition, out Vector3 result);
        ...
        {
            bool succeed = yvrXRDevices[(int)YVRXRDeviceNode.Headset].TryGetFeatureValue(CommonUsages.centerEyeRotation, out Quaternion result);
        ...
        {
            bool succeed = yvrXRDevices[(int)YVRXRDeviceNode.Headset].TryGetFeatureValue(CommonUsages.centerEyeAcceleration, out Vector3 result);
            return succeed ? result : Vector3.zero;
        }
        ...
        {
            bool succeed = yvrXRDevices[(int)YVRXRDeviceNode.Headset].TryGetFeatureValue(CommonUsages.centerEyeAngularAcceleration, out Vector3 result);
            return succeed ? result : Vector3.zero;
        }
        ...
        {
            bool succeed = yvrXRDevices[(int)YVRXRDeviceNode.Headset].TryGetFeatureValue(CommonUsages.centerEyeVelocity, out Vector3 result);
            return succeed ? result : Vector3.zero;
        }
        ...
        {
            bool succeed = yvrXRDevices[(int)YVRXRDeviceNode.Headset].TryGetFeatureValue(CommonUsages.centerEyeAngularVelocity, out Vector3 result);
            return succeed ? result : Vector3.zero;
        }
        ...
        {
            YVRPlugin.Instance.RecenterTracking();
        }
    }
}