        ...
        public void SetInputDataProvider(DataProviderSource source)
        {
            ...
            switch (source)
            {
                case DataProviderSource.HMD:
                    inputDataProvider = enableHMDRayAgent ? (YVRInputDataBaseProvider)new YVRInputDataHMDProvider() : (YVRInputDataBaseProvider)new YVRInputDataDummyProvider();
                    break;
                case DataProviderSource.RightController: // Check right controller first to ensure use right controller while both controllers connected
                    inputDataProvider = new YVRInputDataRControllerProvider();
                    break;
                case DataProviderSource.LeftController:
                    inputDataProvider = new YVRInputDataLControllerProvider();
                    break;
                ...
                default:
                    inputDataProvider = new YVRInputDataDummyProvider();
                    break;
            }
        }
