...
namespace YVR.Core
{
    ...
    public static partial class YVRInput
    {
        ...
        public static ControllerType GetActiveController() { return activeControllerType; }

        /// <summary>
        /// Get last clicked controller
        /// </summary>
        /// <returns></returns>
        public static ControllerType GetClickedController() { return clickedControllerType; }

        /// <summary>
        /// Get last touched controller
        /// </summary>
        /// <returns></returns>
        public static ControllerType GetTouchedController() { return touchedControllerType; }
        ...
        public static int GetControllerBatteryPercentRemaining(ControllerType controllerMask)
        {
            ...
            { return controller.GetBatteryPercentRemaining(); });
        }
