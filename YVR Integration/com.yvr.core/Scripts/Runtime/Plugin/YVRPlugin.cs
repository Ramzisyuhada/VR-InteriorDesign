...
namespace YVR.Core
{
    ...
    public abstract partial class YVRPlugin
    {
        ...
        public virtual bool IsRecenterOccurred() { return false; }
        ...
        public virtual void AddRenderLayer(int compositionDepth) { }
        ...
        public virtual void TestBoundaryNode(YVRBoundary.BoundaryNode node, ref YVRBoundary.BoundaryTestResult testResult) { }
